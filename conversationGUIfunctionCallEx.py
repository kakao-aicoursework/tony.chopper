    ...
    functions = [
        {
            ...
            "description": "Saves the given playlist data into a CSV assets when the user confirms the playlist.",
            "parameters": {
                "type": "object",
                "properties": {
                    "playlist_csv": {
                        "type": "string",
                        "description": "A playlist in CSV format separated by ';'. It must contains a header and the release year should follow the 'YYYY' format. The CSV content must starts with a new line. The header of the CSV assets must be in English and it should be formatted as follows: 'Title;Artist;Released'.",
                    },
                },
